    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        acceptbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Call<String> call = rc.getApi().pay(pref.getAppRegId(), coupnId.toString().trim(), pref.getAppRegId());
                        ...
                        if (response.isSuccessful()) {
                            ...
                            if (res!=null) {
                                if (res.equals("true")) {
                                    ...
                                    Toast.makeText(UserAcceptRejectRequestActivity.this, "پرداخت با موفقیت انجام شد", Toast.LENGTH_LONG).show();
                                }
                                else{
                                    Toast.makeText(UserAcceptRejectRequestActivity.this, "خطا در پرداخت", Toast.LENGTH_SHORT).show();
                                    // Pbar.setVisibility(View.GONE);
                                }
                            }
                            else {
